...
2. Context compaction survival pattern with XML template
3. Large file handling pattern with chunked reading strategy
4. Avoiding arbitrary limits pattern (the head -N problem)
5. Progress tracking with validation rules
6. Checkpoint strategies
7. Begin section template (check for existing progress first)
8. Critical reminders template
